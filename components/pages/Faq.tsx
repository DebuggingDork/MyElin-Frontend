...
const faqs: FaqItem[] = [
  {
    q: "Is this an LMS?",
    a: "No. Myelin is not an LMS. An LMS is primarily designed to deliver and organize learning content—courses, lectures, videos, assignments, quizzes, and assessments. Myelin is designed around decision practice. There are no chapters to complete before you can act. The learner enters a situation, receives information, makes decisions, allocates resources, and sees the simulated environment respond. The important difference is the learning loop: Situation → Decision → Consequence → New Information → Adaptation → Reflection. A student does not simply answer: “What is the correct management decision?” They have to make the decision and then deal with what that decision creates. Myelin can therefore complement an LMS rather than replace it. A university can use its existing LMS for curriculum, content, assignments, and administration, while using Myelin for experiential decision practice and simulation-based assessment.",
    topic: "Product",
  },
  {
    q: "How is my decision graded?",
    a: "Myelin does not grade you simply on whether you “won.” The simulation records the decisions you make throughout the experience and evaluates them against the situation, information available at the time, constraints, trade-offs, and consequences. The current Myelin framework evaluates seven dimensions: Strategic Thinking, Capital Allocation, Risk Management, Systems Thinking, Leadership & People Management, Adaptability, and Long-Term Value Creation. A strong outcome alone does not automatically mean a strong decision. A student can make a sensible decision and still experience a poor external outcome. Conversely, a poor decision can occasionally produce a good outcome. That distinction matters because Myelin is designed to evaluate judgment, not luck. The final report therefore combines the student's overall performance with their decision history, quarter-by-quarter outcomes, strengths, mistakes, missed opportunities, and recurring patterns.",
    topic: "Scoring",
  },
  {
    q: "Can I retake a simulation?",
    a: "Yes. Retakes are designed for learning, not for simply replacing a bad result. A second attempt gives the learner an opportunity to apply what they learned from the first experience. The purpose is to answer a more meaningful question: Did you actually improve your decision-making after experiencing the consequences? A retake can therefore reveal whether the student: recognized what went wrong, changed their assumptions, adapted their strategy, made better trade-offs, and avoided repeating the same mistakes. For institutional assessment, Myelin should clearly distinguish between first-run performance, subsequent attempts, and demonstrated improvement rather than presenting the highest score without context.",
    topic: "Runs",
  },
  {
    q: "Is the AI generating the scenarios?",
    a: "AI can support scenario creation and adaptation, but AI is not the simulation itself. Myelin's core experience is built around a structured decision environment containing: objectives, constraints, information, resources, stakeholders, decisions, consequences, and changing conditions. The underlying simulation engine determines how decisions affect the state of the environment. AI can make the experience more dynamic—for example, by supporting realistic interactions, communications, scenario variations, or adaptive content—but the business logic and consequence system remain structured and measurable. That distinction is important. AI generates or assists with parts of the experience. The simulation engine determines whether the student's decisions actually matter.",
    topic: "Engine",
  },
  {
    q: "Will recruiters actually use the DI Report?",
    a: "The Decision Intelligence Report is not intended to replace a résumé, interview, degree, or professional experience. Its purpose is to provide an additional source of evidence about how a person approaches decisions in simulated situations. A conventional résumé tells an employer what someone has done. A simulation can provide evidence about how that person behaves when they have to: make trade-offs, operate with incomplete information, manage risk, allocate limited resources, respond to changing conditions, and adapt when their assumptions prove wrong. The report can summarize these patterns across the simulation and present the evidence in a structured format. For universities, the same report can be used for learning feedback and development, rather than recruitment alone. The important boundary is that Myelin should not claim: “This report proves how you will perform at work.” Instead: “This report provides structured evidence of how you made decisions in the simulation.” That distinction keeps the report credible.",
    topic: "Reports",
  },
  {
    q: "Is there a free tier?",
    a: "Yes. Myelin can provide an accessible entry point through selected free simulation experiences. Paid plans can provide access to a broader set of simulations and deeper capabilities, while institutional plans can support cohort-level use, instructor visibility, reporting, and deployment across an educational program. The exact commercial structure should be presented according to the current pricing model rather than making claims that are not yet finalized. The underlying model is simple: Experience Myelin first. Expand access when deeper learning, analytics, and institutional use require it.",
    topic: "Plans",
  },
  {
    q: "Who is behind Myelin?",
    a: "Myelin is built around a simple belief: Judgment is not something you should have to wait years to develop. Education gives people knowledge. Experience gives people consequences. Myelin is designed to create a place between the two where learners can practice making consequential decisions before the stakes are real. The platform brings together simulation design, decision modeling, learning science, software engineering, and assessment to create experiences where the learner—not the instructor—is responsible for what happens next. Rather than teaching one narrow subject, Myelin is being designed as a reusable decision-intelligence platform that can support different environments, from business and leadership to crisis, operations, and other organizational decision contexts. The goal is simple: give people a place to practice judgment before the real world demands it.",
    topic: "Company",
  },
];
