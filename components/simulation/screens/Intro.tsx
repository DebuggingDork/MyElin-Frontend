  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="grid gap-8 lg:grid-cols-[1.3fr_1fr] lg:items-start">
        <div>
          ...
          <p className="text-lg text-ink leading-relaxed mt-5 text-pretty">
            You are the chief executive. The company sells a smartwatch called the Nadi Pulse at {inr(price)}, has four
            thousand customers, fourteen people and {inr(OPENING_CASH)} in the bank. The category buys about{" "}
            {n0(marketDemand(1))} units a quarter and you are a small part of that. Three funded competitors would like
            you to stay small.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Panel eyebrow="How this works" title="Four decisions a quarter, and one you cannot take back">
          <p className="text-sm text-dim">
            Each quarter opens with a briefing: what changed, what is holding the company back, and what everyone
            around you wants. You declare a priority, make your decisions, and close the quarter. Then you find out
            what actually happened.
          </p>
          <p className="text-sm text-dim mt-3">
            You will not be shown your revenue before you commit. You will be shown pressure — where the company is
            tight, where it has room — and you will have to decide with that. That is the situation the job is
        ...
        <Panel eyebrow="What is being assessed" title="Judgment, not arithmetic">
          <p className="text-sm text-dim">
            Every quarter you say what you are prioritising and what you are giving up. At the close, those are
            compared with what your money actually did and what the company turned out to need. Consequences arrive
            late and out of order, which is the point.
          </p>
        </Panel>
      </div>
      ...
      <button
        ...
        disabled={busy}
        className={
          "w-full py-4 font-serif text-xl transition-colors duration-150 " +
          (busy ? "bg-raise-2 text-faint" : "bg-danger-deep text-white hover:bg-teal-deep")
        }
      >
